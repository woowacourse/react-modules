...
- [ ] 카드사 식별 (AMEX, Diners, UnionPay 포함)
  - [ ] 4로 시작하는 경우 VISA를 반환한다.
  - [ ] 51 - 55로 시작하는 경우 Master을 반환한다.
  - [ ] 36으로 시작하는 경우 Diners를 반환한다.
  - [ ] 34 - 37로 시작하는 경우 AMEX를 반환한다.
  - [ ] 622126~622925로 시작하는 경우 UnionPay를 반환한다.
  - [ ] 624~626로 시작하는 경우 UnionPay를 반환한다.
  - [ ] 6282~6288로 시작하는 경우 UnionPay를 반환한다.
- [ ] 유효성 검사 로직 테스트
