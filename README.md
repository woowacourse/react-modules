...
- 다양한 카드 브랜드 지원을 확장한다.
  - [x] 주요 카드사를 식별한다.
    - [x] Visa : 4로 시작하는 16자리 숫자인 경우 'Visa'를 반환한다.
    - [x] Master : 51 - 55로 시작하는 16자리 숫자안 경우 'Master'을 반환한다.
    - [x] Diners : 36으로 시작하는 14자리 숫자인 경우 'Diners'를 반환한다.
    - [x] AMEX : 34, 37로 시작하는 15자리 숫자인 경우 'AMEX'를 반환한다.
    - [x] 유니온페이 : 카드의 앞 번호가 아래 3가지 조건을 만족하는 16자리 숫자인 경우 'unionPay'를 반환한다.
      - [x] 622126~622925로 시작하는 경우
      - [x] 624~626로 시작하는 경우
      - [x] 6282~6288로 시작하는 경우
  - [x] 주요 카드사의 카드 번호 유효성 검사를 수행한다.
    - [x] 주요 카드사의 식별 번호에 해당하지 않는 경우 오류를 반환한다.
- 카드 번호 포맷팅 기능을 추가한다.
  - [x] 사용자 입력 시 자동으로 카드사별 규칙에 맞게 카드 번호를 구분하여 표시한다.
    - [x] Visa
      - [x] 4로 시작하는 경우 : 4567 1234 1234 1234
    - [x] Master
      - [x] 51로 시작하는 경우 : 5132 1234 1234 1234
      - [x] 52로 시작하는 경우 : 5232 1234 1234 1234
      - [x] 53로 시작하는 경우 : 5332 1234 1234 1234
      - [x] 54로 시작하는 경우 : 5432 1234 1234 1234
      - [x] 55로 시작하는 경우 : 5532 1234 1234 1234
    - [x] Diners
      - [x] 36으로 시작하는 경우 : 3612 345678 9012
    - [x] AMEX
      - [x] 34로 시작하는 경우 : 3412 345678 90123
      - [x] 37로 시작하는 경우 : 3712 345678 90123
    - UnionPay
      - [x] 622126~622925로 시작하는 경우 : 6221 2612 3456 7890
      - [x] 624~626로 시작하는 경우 : 6240 1234 5678 9012
      - [x] 6282~6288로 시작하는 경우 : 6282 1234 5678 9012
...
- [x] 유효성 검사 로직 테스트
  - [x] 카드사에 해당하지 않는 번호 입력시 유효하지 않는 카드 번호라는 메시지를 반환한다.
- [x] 카드 번호 포맷팅 기능 테스트
  - [x] VISA & Master & UnionPay인 경우 4-4-4-4 포맷팅을 반환한다.
  - [x] Diners인 경우 4-6-4 포맷팅을 반환한다.
  - [x] AMEX인 경우 4-6-5 포맷팅을 반환한다.
